...
final_chart = (
    ...
    .encode(
        ...
        color=alt.Color('cluster_label:N', 
                        ...
                        # FLIPPED: reverse=False means Positive = Red, Negative = Blue
                        scale=alt.Scale(scheme='redblue', reverse=False, domainMid=0),
                        legend=alt.Legend(
                            orient='right', 
                            columns=1,
                            symbolLimit=0,
...
<head>
  ...
  <style>
    ...
    .tab-container { display: flex; justify-content: center; gap: 10px; margin: 20px 0; }
    ...
    .app-wrapper { padding: 10px 30px; display: flex; flex-direction: column; align-items: center; }
    #vis-container { 
...
<body>
  ...
  <script>
    function showTab(tabName) {
        ...
        if (tabName === 'map') {
            mapTab.style.display = 'block'; helpTab.style.display = 'none';
            buttons[0].classList.add('active'); buttons[1].classList.remove('active');
        } else {
            mapTab.style.display = 'none'; helpTab.style.display = 'block';
...
final_chart = (
    ...
    .encode(
        ...
        color=alt.Color('growth_val:Q', 
                        title='Growth Scale (# of abstracts)',
                        scale=alt.Scale(
                            scheme='redblue', 
                            reverse=True, 
                            domain=[-25, 25],
